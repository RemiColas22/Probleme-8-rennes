...
sol = JeuReines(n) #on creer l'objet pour resoudre le probleme
sol.solutions() # on lance la resolution
temps_fin = time.time() #on reprend le temps
print("Solutions :")
sol.afficher() #affiche les solutions
print("Pour ",n,"reine \nTemps d'execution :", temps_fin - temps_debut, "secondes /", (temps_fin - temps_debut)/60, "minutes")
